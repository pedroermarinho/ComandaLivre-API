...
public class ProductUpdateController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductRecord> updateProduct(@PathVariable UUID id, @Valid @RequestBody ProductForm productForm) {
        final ProductRecord product = updateProduct.execute(id, productConvert.convert(productForm));
